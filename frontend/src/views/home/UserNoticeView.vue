<!-- src/views/home/UserNoticeView.vue -->
<template>
    ...
    <div class="layout-container">
      ...
      <main class="main-content">
        ...
        <section class="page-header">
          ...
          <p class="page-subtitle">请仔细阅读以下公告，确认后进入首页</p>
        </section>
        ...
        <section class="notice-list-section">
          ...
          <div v-else-if="notices.length === 0 && notifications.length === 0" class="empty-container">
            ...
            <button class="confirm-btn" @click="enterHome">
              进入首页
            </button>
          </div>
    ...
    notices.value = [
      {
        ...
        type: 'system',
        title: '系统维护通知',
        content: '系统将于本周六凌晨2:00-4:00进行例行维护，期间可能无法访问，请提前安排。',
      ...
      },
      {
        ...
        type: 'notice',
        title: '新功能上线',
        content: '失物招领系统新增实时沟通功能，您可以与拾主/失主直接联系了！',
...
const enterHome = () => {
  ...
  // 记录已阅读公告
  sessionStorage.setItem('hasReadNotices', 'true')
...
const handleLogout = async () => {
  try {
    ...
    if (userId) {
      await axios.post('/api/user/logout', { userId: parseInt(userId) })
    }
  } catch (error) {
